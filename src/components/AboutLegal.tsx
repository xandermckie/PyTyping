    ...
    <div className="mx-auto w-full max-w-2xl pb-12">
      ...
      <div className="flex flex-col gap-6">
        ...
        <Section title="Privacy">
          PyTyping runs entirely in your browser. There is no server and no analytics or tracking of
          any kind. Guest progress is stored only for the current browser session (sessionStorage).
          When you create an account, your data and settings are stored locally on your device
          (localStorage); passwords are salted and hashed (PBKDF2-SHA-256), never stored in plain
          text. Use Export backup in Settings to move your data between devices.
        </Section>
